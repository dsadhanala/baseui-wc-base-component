...
import { Component, html } from '@rootSrc/with-hyperHTML';
...
@CustomElement('toggle-view-hyper')
export class ToggleViewHyper extends Component {
    ...
    render({ htmlWithContext, domRender, view, userSwitchHandler }: this) {
        ...
        return domRender`
            <section view="${view}" onclick="${this}" class="view-wrapper">
