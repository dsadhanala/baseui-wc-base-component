(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("baseuiWcBaseComponent", ["lit-html", "hyperhtml"], factory);
	else if(typeof exports === 'object')
		exports["baseuiWcBaseComponent"] = factory(require("lit-html"), require("hyperhtml"));
	else
		root["baseuiWcBaseComponent"] = factory(root["lit-html"], root["hyperhtml"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE__7__, __WEBPACK_EXTERNAL_MODULE__27__) {
...
var es6_regexp_replace = __webpack_require__(93);
...
// CONCATENATED MODULE: ./src/test-utils/mount/index.ts
...
function mount(component) {
  ...
  function () {
    ...
    return function whenResolved(_x) {
...
/* harmony default export */ var test_utils_mount = (mount);
// CONCATENATED MODULE: ./src/test-utils/index.ts

// EXTERNAL MODULE: ./node_modules/core-js/modules/es7.symbol.async-iterator.js
var es7_symbol_async_iterator = __webpack_require__(18);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es6.symbol.js
var es6_symbol = __webpack_require__(17);

// EXTERNAL MODULE: ./src/_global-types/index.ts
var _global_types = __webpack_require__(45);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es6.string.iterator.js
var es6_string_iterator = __webpack_require__(80);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es6.map.js
var es6_map = __webpack_require__(78);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es6.reflect.construct.js
var es6_reflect_construct = __webpack_require__(74);
...
var es6_number_constructor = __webpack_require__(69);

// CONCATENATED MODULE: ./src/base-component/serialize/index.ts
...
function logError(_ref) {
  var attrName = _ref.attrName,
      ...
      actual = _ref.actual;
  if (validate) return;
  throw new Error("PropType mismatch for attribute \"".concat(attrName, "\": Expected value type is \"").concat(expected, "\" but received \"").concat(actual, "\""));
}
/**
 * serialize attribute value from string, log error if type mismatched
 */

function serializeAttrValue(attrName, value, type) {
  // when the value is undefined/null
  if (value == null) return value; // when property is defined as string type
  ...
  try {
    ...
    throw new Error("Warning: Failed serializing attribute(".concat(attrName, ") value as JSON: ").concat(value));
  }
}
/* harmony default export */ var serialize = (serializeAttrValue);
// CONCATENATED MODULE: ./src/base-component/bootstrap-element/index.ts
...
function bootstrap_element_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { bootstrap_element_typeof = function _typeof(obj) { return typeof obj; }; } else { bootstrap_element_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return bootstrap_element_typeof(obj); }
...
function _possibleConstructorReturn(self, call) { if (call && (bootstrap_element_typeof(call) === "object" || typeof call === "function")) { return call; } return _assertThisInitialized(self); }
...
var bootstrap_element_BootstrapElement =
/*#__PURE__*/
function (_HTMLElement) {
  _inherits(BootstrapElement, _HTMLElement);

  function BootstrapElement() {
    _classCallCheck(this, BootstrapElement);

    return _possibleConstructorReturn(this, _getPrototypeOf(BootstrapElement).apply(this, arguments));
  }

  _createClass(BootstrapElement, [{
    key: "defineProp",
     ...
     */
    value: function defineProp(name, reflectedAttrToProps) {
      var _this = this;

      if (!name) return;
      var propName = toCamelCase(name);
      var _reflectedAttrToProps = reflectedAttrToProps[name],
          type = _reflectedAttrToProps.type,
          observe = _reflectedAttrToProps.observe;

      var get = function get() {
        var value = _this.getAttribute(name); // if boolean attribute check if attribute exist or not


        if (true.constructor === type && !value) return _this.hasAttribute(name);
        return serializeAttrValue(name, value, type);
      };

      var set = function set(value) {
        if (!observe) return;
        var valueAsString = String(value); // when value is null or false remove attribute

        if (value == null || valueAsString === 'false') return _this.removeAttribute(name); // set boolean attribute

        if (valueAsString === 'true') return _this.setAttribute(name, ''); // when value is a empty string then simply set that as attribute value
    ...
    value: function createAttributesToProperties(reflectedAttrToProps) {
      var _this2 = this;

      Object.keys(reflectedAttrToProps).forEach(function (attrName) {
        return _this2.defineProp(attrName, reflectedAttrToProps);
      });
    }
    /**
     * has attribute
    ...
    value: function trigger(eventName) {
      var target = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this;
      var eventData = arguments.length > 2 ? arguments[2] : undefined;
      var triggerEvent = !eventData ? new Event(eventName) : new CustomEvent(eventName, {
        detail: eventData || {}
      });
...
// CONCATENATED MODULE: ./src/base-component/validate-required-attributes/index.ts
 ...
 */
function validateRequiredAttributes(_ref) {
  ...
  Object.keys(attrs).forEach(function (key) {
    ...
    if (!isDefined(value)) {
      console.error("".concat(ele, ": Missing attribute '").concat(key, "'"));
      validate = false;
      return;
    }

    if (typeof value === 'string' && value.length === 0) {
      console.error("".concat(ele, ": attribute '").concat(key, "' value is empty, is this expected?"));
      validate = false;
      return validate;
    }
  });
...
/* harmony default export */ var validate_required_attributes = (validateRequiredAttributes);
...
function custom_element_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { custom_element_typeof = function _typeof(obj) { return typeof obj; }; } else { custom_element_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return custom_element_typeof(obj); }

function custom_element_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function custom_element_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { custom_element_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { custom_element_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
var custom_element_BaseUICustomElement =
/*#__PURE__*/
function (_BootstrapElement) {
  custom_element_inherits(BaseUICustomElement, _BootstrapElement);

  custom_element_createClass(BaseUICustomElement, null, [{
    key: "define",
    value: function define(elementName, options) {
      var _window = window,
    ...
    get: function get() {
      ...
      return Object.keys(observeAttrs).filter(function (item) {
        return observeAttrs[item].observe;
      });
    }
  }]);
  ...
  function BaseUICustomElement() {
    ...
    custom_element_classCallCheck(this, BaseUICustomElement);

    _this = custom_element_possibleConstructorReturn(this, custom_element_getPrototypeOf(BaseUICustomElement).call(this));

    _defineProperty(custom_element_assertThisInitialized(custom_element_assertThisInitialized(_this)), "state", void 0);

    _defineProperty(custom_element_assertThisInitialized(custom_element_assertThisInitialized(_this)), "isFirstRender", void 0);

    _defineProperty(custom_element_assertThisInitialized(custom_element_assertThisInitialized(_this)), "isCreated", void 0);

    _defineProperty(custom_element_assertThisInitialized(custom_element_assertThisInitialized(_this)), "shouldRender", false);
  ...
  custom_element_createClass(BaseUICustomElement, [{
    ...
    value: function handleEvent(e) {
      ...
      var hasInstanceMethod = "on".concat(eventType);
    ...
    value: function afterRender() {
      ...
      this.didRender();
      if (_global_types["DEV_FEATURE"]) console.timeEnd(this.elementName);
    }
  }, {
    key: "create",
    value: function create() {
      var reflectedAttrToProps = this.constructor.attrToProp; // poxy attributes & observed attributes as properties
    ...
    key: "hasRequiredAttributes",
    value: function hasRequiredAttributes() {
      var _this2 = this;

      // validate required attributes before rendering
      var CTOR = this.constructor;
      var observeAttrs = CTOR.attrToProp || {};
      var requiredAttrs = Object.keys(observeAttrs).filter(function (item) {
        return observeAttrs[item].require;
      }).reduce(function (accum, attr) {
        accum[attr] = _this2[toCamelCase(attr)];
        return accum;
      }, {}); // console.log(requiredAttrs);

      return validateRequiredAttributes({
        attrs: _objectSpread({}, requiredAttrs),
    ...
    key: "beforeRender",
    value: function () {
      var _beforeRender = custom_element_asyncToGenerator(
      /*#__PURE__*/
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                this.shouldRender = true; // batch render all changes at once to improve performance with below microtask queue
              ...
              case 6:
                ...
                if (_global_types["DEV_FEATURE"]) console.time(this.elementName); // validate all required attributes before render
...
}(bootstrap_element_BootstrapElement);
...
_defineProperty(custom_element_BaseUICustomElement, "elementName", void 0);

/* harmony default export */ var custom_element = (custom_element_BaseUICustomElement);
// EXTERNAL MODULE: external "hyperhtml"
var external_hyperhtml_ = __webpack_require__(27);

// CONCATENATED MODULE: ./src/with-hyperHTML/index.ts



function with_hyperHTML_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { with_hyperHTML_typeof = function _typeof(obj) { return typeof obj; }; } else { with_hyperHTML_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return with_hyperHTML_typeof(obj); }

function with_hyperHTML_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function with_hyperHTML_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function with_hyperHTML_createClass(Constructor, protoProps, staticProps) { if (protoProps) with_hyperHTML_defineProperties(Constructor.prototype, protoProps); if (staticProps) with_hyperHTML_defineProperties(Constructor, staticProps); return Constructor; }

function with_hyperHTML_possibleConstructorReturn(self, call) { if (call && (with_hyperHTML_typeof(call) === "object" || typeof call === "function")) { return call; } return with_hyperHTML_assertThisInitialized(self); }

function with_hyperHTML_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function with_hyperHTML_getPrototypeOf(o) { with_hyperHTML_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return with_hyperHTML_getPrototypeOf(o); }

function with_hyperHTML_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) with_hyperHTML_setPrototypeOf(subClass, superClass); }

function with_hyperHTML_setPrototypeOf(o, p) { with_hyperHTML_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return with_hyperHTML_setPrototypeOf(o, p); }
...
var with_hyperHTML_html = function html(template) {
  for (var _len = arguments.length, values = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
    values[_key - 1] = arguments[_key];
  }

  return Object(external_hyperhtml_["wire"])().apply(void 0, [template].concat(values));
};
/**
 *
...
var with_hyperHTML_htmlWithContext = external_hyperhtml_["wire"];
/**
 *
...
var with_hyperHTML_renderFn = function renderFn(template, renderRoot) {
  return Object(external_hyperhtml_["bind"])(renderRoot)(template);
};
/**
 * DOM rendering with HyperHTML which extendes from base custom element
 */

var with_hyperHTML_Component =
/*#__PURE__*/
function (_BaseUICustomElement) {
  with_hyperHTML_inherits(Component, _BaseUICustomElement);

  function Component() {
    with_hyperHTML_classCallCheck(this, Component);

    return with_hyperHTML_possibleConstructorReturn(this, with_hyperHTML_getPrototypeOf(Component).apply(this, arguments));
  }

  with_hyperHTML_createClass(Component, [{
    key: "domRender",
    get: function get() {
      var _this = this;
      ...
      return function (template) {
        ...
        return Object(external_hyperhtml_["bind"])(_this.shadowRoot || _this).apply(void 0, [template].concat(values));
      };
    }
  }, {
    key: "html",
    ...
    key: "htmlWithContext",
    get: function get() {
      return with_hyperHTML_htmlWithContext;
    }
  }]);

  return Component;
}(custom_element);
/* harmony default export */ var with_hyperHTML = ({
  Component: with_hyperHTML_Component,
  html: with_hyperHTML_html,
  htmlWithContext: with_hyperHTML_htmlWithContext
});
// EXTERNAL MODULE: external "lit-html"
var external_lit_html_ = __webpack_require__(7);

// CONCATENATED MODULE: ./src/with-litHTML/index.ts



function with_litHTML_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { with_litHTML_typeof = function _typeof(obj) { return typeof obj; }; } else { with_litHTML_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return with_litHTML_typeof(obj); }
...
function with_litHTML_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function with_litHTML_createClass(Constructor, protoProps, staticProps) { if (protoProps) with_litHTML_defineProperties(Constructor.prototype, protoProps); if (staticProps) with_litHTML_defineProperties(Constructor, staticProps); return Constructor; }

function with_litHTML_possibleConstructorReturn(self, call) { if (call && (with_litHTML_typeof(call) === "object" || typeof call === "function")) { return call; } return with_litHTML_assertThisInitialized(self); }

function with_litHTML_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function with_litHTML_getPrototypeOf(o) { with_litHTML_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return with_litHTML_getPrototypeOf(o); }

function with_litHTML_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) with_litHTML_setPrototypeOf(subClass, superClass); }

function with_litHTML_setPrototypeOf(o, p) { with_litHTML_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return with_litHTML_setPrototypeOf(o, p); }
...
var with_litHTML_htmlWithContext = function htmlWithContext() {
  return function (template) {
    ...
    return external_lit_html_["html"].apply(void 0, [template].concat(values));
  };
};
/**
...
var with_litHTML_Component =
/*#__PURE__*/
function (_BaseUICustomElement) {
  with_litHTML_inherits(Component, _BaseUICustomElement);

  function Component() {
    with_litHTML_classCallCheck(this, Component);

    return with_litHTML_possibleConstructorReturn(this, with_litHTML_getPrototypeOf(Component).apply(this, arguments));
  }

  with_litHTML_createClass(Component, [{
    key: "domRender",
    get: function get() {
      var _this = this;
      ...
      return function (template) {
        ...
        return Object(external_lit_html_["render"])(external_lit_html_["html"].apply(void 0, [template].concat(values)), _this.shadowRoot || _this);
      };
    }
  }, {
    key: "html",
...
/* harmony default export */ var with_litHTML = ({
  Component: with_litHTML_Component,
  html: external_lit_html_["html"],
  htmlWithContext: with_litHTML_htmlWithContext
});
// CONCATENATED MODULE: ./src/index.ts
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "toHyphenCase", function() { return toHyphenCase; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "toCamelCase", function() { return toCamelCase; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "isEmptyObject", function() { return isEmptyObject; });
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "mount", function() { return mount; });
...
var BROKEN_COF = cof(__webpack_require__(21)(proto)) == NUMBER;
...
// 21.2.5.3 get RegExp.prototype.flags()
if (__webpack_require__(3) && /./g.flags != 'g') __webpack_require__(6).f(RegExp.prototype, 'flags', {
  configurable: true,
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(14)(Function.call, __webpack_require__(32).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
