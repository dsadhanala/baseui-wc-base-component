 ...
 */
export declare abstract class BootstrapElement extends HTMLElement {
    /**
     ...
     * @return {object} element DOM element
     */
    removeClass(className: string, target?: Element): Element;
    /**
     ...
     */
    trigger(eventName: string, target?: HTMLElement, eventData?: {}): void;
}
