 ...
 */
export declare function toCapitalCase(word: string): string;
/**
...
export declare function parsedArrayOrObjectValue(attrName: string, value: string): any;
/**
 ...
 */
export declare function serializeAttrValue(proto: any, attrName: string, value: string, type: (val: any) => any): any;
export {};
